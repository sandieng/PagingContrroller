...
import { SiteDiaryViewModel } from "../../site-diary/view-model/site-diary-view-model";
  ...
  beforeEach((done) => {
    TestBed
      .configureTestingModule({
        imports: [],
        declarations: [Pagination, PaginationComponentWrapper],
        providers: []
      })
      .compileComponents()
      .then(() => {
...
@Component({
  selector: 'paging-component-wrapper',
  template: '<app-paging-control [pageData]="allSiteDiaries"></app-paging-control>'
})
class PaginationComponentWrapper {
  sampleList = [ 
    {'id': 1, 'title': 'typescript vol 1'}, 
    {'id': 2, 'title': 'typescript vol 2'},
    {'id': 3, 'title': 'typescript vol 3'},
